                  ...
                  signPrices.map((sign, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div className="w-10 h-10 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded p-1 flex items-center justify-center overflow-hidden flex-shrink-0 self-center">
                          <img
